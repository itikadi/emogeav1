...
```
We start with the initial steps of analysing categorical/case-control/binary design experiments. These experiments represent measurements where the interest is to compare differential expression between two independent groups e.g., a treatment and a control or one treatment to another.
